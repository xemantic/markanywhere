...
class OpenjurTest {
    ...
    fun `should convert captured openjur DOM dump to Markdown`() = runTest {
        ...
        markdown sameAs """
            ...
            <header>
            <nav>
            [![openJur](https://cdn.openjur.net/img/logo.svg)](ref:1:/)<button type="button" aria-label="Toggle navigation" aria-expanded="false">
            </button>
            - [Rechtsprechung](ref:2:#)
              ...
              - [Gericht](#)
            - [Informationen](ref:3:#)
              - [Über openJur](/i/ueber.html)
              - [Hilfe](#)
              - [Urschrift des Grundgesetzes](/i/grundgesetz.html)
              - [Fachzeitschriften](/s/fachzeitschriften.html)
              - [Abkürzungen](/s/abkuerzungen.html)
              - [Spenden](/s/spende.html)
              - [API](#)
              - [Changelog](/s/changelog.html)
              - [Datenschutz](/i/datenschutz.html)
              - [Nutzungsbedingungen](/i/nutzungsbedingungen.html)
              - [Impressum](/i/impressum.html)
            ...
            <dl><dt>Einfach</dt><dd>KG, Urteil vom 15.09.2021 - 5 U 35/20</dd><dt>m. Fundstelle</dt><dd>KG, Urteil vom 15.09.2021 - 5 U 35/20 = openJur 2022, 4663</dd></dl>
            - [BibTeX](https://openjur.de/u/2388450.bibtex)
            - [RIS](https://openjur.de/u/2388450.ris)
            - [JSON](https://openjur.de/u/2388450.bib)

            ###### [KG](ref:11:/be/kg.html), Urteil vom 15.09.2021 - 5 U 35/20
            FundstelleopenJur 2022, 4663 Rechtskraft: ❓<button type="button" aria-expanded="false" ref="12">
            Optionen
            </button>

            - [:square-quote: Zitierung](#)
            - [ℹ️ Versionen](https://openjur.de/u/2388450-nfo.html)
